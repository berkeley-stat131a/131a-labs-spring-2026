...
**Due Date**: Monday March 2nd at midnight.

Labs are submitted via Gradescope.

-   You will submit (1) the two .Rmd files with your code from parts A and B, (2) the two PDFs of your code and output from parts A and B
