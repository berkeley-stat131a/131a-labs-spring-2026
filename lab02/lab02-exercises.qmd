...
**Due Date**: Thursday February 12th at 11:59PM

Labs are submitted via Gradescope.

-   You will submit (1) a .qmd file with your code and (2) a PDF of your code and output.
-   To generate a PDF of your code and output, **do not render to PDF**. Instead, knit your .qmd file as HTML, open the HTML file in a web browser, and then **print the HTML as a PDF, making sure that none of your code or output is cut off.** You can generate an HTML file in RStudio by pressing `Render`.
