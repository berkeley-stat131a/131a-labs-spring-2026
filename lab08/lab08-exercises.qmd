...
**Due Date**: Sunday, April 12nd at 11:59PM.
...
-   **N.B.** In class we use MSPE (RMSPE): "(root) mean square *prediction* error", but in this lab we'll drop the "p", as most literature does.
